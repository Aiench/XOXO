...
productBtn.forEach((el) => {
  el.closest(".jemper").setAttribute("data-id", randomId());
  el.addEventListener("click", (e) => {
    let self = e.currentTarget;
    let parent = self.closest(".jemper");
    let id = parent.dataset.id;
    let img = parent.querySelector(".red").getAttribute("src");
    let title = parent.querySelector(".boyssdescr").textContent;
